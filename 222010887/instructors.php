...
<section>
    ...
    <form method="post" onsubmit="return confirmInsert();">
        ...
        <input type="text" id="ex" name="ex" required><br><br>

        <label for="bo">Bio:</label>
        <input type="text" id="bo" name="bo" required><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO instructors(Instructor_ID,FullName,Expertise,Bio) VALUES (?, ?, ?,?)");
    $stmt->bind_param("isss", $iid, $fn, $ex,$bo);
