...
<head>
  ...
  <title>digital marketing resource</title>
  <style>
    /* Normal link */
    a {
      padding: 10px;
...
<section>
    ...
    <h1><u>Digital marketing resource Form </u></h1>
    <form method="post" onsubmit="return confirmInsert();">
        ...
        <input type="text" id="ul" name="ul" required><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO digital_marketing_resource( Resource_ID, Title, Description,URL) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("isss", $rid, $tl, $dn, $ul);
...
// SQL query to fetch data from the digital marketing resource table
$sql = "SELECT * FROM digital_marketing_resource";
...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Detail information Of digital marketing resource</title>
    <style>
        table {
            width: 100%;
...
<body>
    <center><h2>Table of digital marketing resource</h2></center>
    <table border="5">
        <tr>
            <th>Resource_ID</th>
            <th>Title</th>
      ...
      include('database_connection.php');
        ...
        // Prepare SQL query to retrieve all digital marketing resource
        $sql = "SELECT * FROM digital_marketing_resource";
        $result = $connection->query($sql);
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                    ...
                    <td>" . $row['URL'] . "</td>
                    <td><a style='padding:4px' href='delete_digital_marketing_resource.php?Resource_ID=$rid'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_digital_marketing_resource.php?Resource_ID=$rid'>Update</a></td> 
                </tr>";
            }
        } else {
